...
class ProductFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'id_type_product' => ['type' => 'integer', 'length' => null, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'id_type_product' => ['type' => 'index', 'columns' => ['id_type_product'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'product_ibfk_2' => ['type' => 'foreign', 'columns' => ['id_type_product'], 'references' => ['type_product', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'id_trademark' => 1,
                'id_type_product' => 1,
                'created_at' => 1602064628,
                'updated_at' => 1602064628,
                'deleted' => 1,
            ],
        ];
        parent::init();
